...
versions of Tor see [Section 3](#3-automatically-listen-on-tor).*
	...
	HiddenServicePort 8647 127.0.0.1:8647
	HiddenServicePort 18647 127.0.0.1:18647

The directory can be different of course, but (both) port numbers should be equal to
your bitcoind's P2P listen port (8647 by default).
...
and open port 8647 on your firewall (or use -upnp).
