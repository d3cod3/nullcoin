...
{
    BOOST_CHECK(TestSplitHost("www.nullcoincore.org", "www.nullcoincore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.nullcoincore.org]", "www.nullcoincore.org", -1));
    BOOST_CHECK(TestSplitHost("www.nullcoincore.org:80", "www.nullcoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.nullcoincore.org]:80", "www.nullcoincore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:8647", "127.0.0.1", 8647));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:8647", "127.0.0.1", 8647));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:8647", "::ffff:127.0.0.1", 8647));
    BOOST_CHECK(TestSplitHost("[::]:8647", "::", 8647));
    BOOST_CHECK(TestSplitHost("::8647", "::8647", -1));
    BOOST_CHECK(TestSplitHost(":8647", "", 8647));
    BOOST_CHECK(TestSplitHost("[]:8647", "", 8647));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:8647", "127.0.0.1:8647"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:8647", "[::]:8647"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
