...
//! Entry point for NullcoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &NullcoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for NullcoinGUI tests.
void AppTests::guiTests(NullcoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &NullcoinGUI::consoleShown, this, &AppTests::consoleTests);
