...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, NullcoinUnits::SeparatorStyle separators=NullcoinUnits::separatorStandard) const;
