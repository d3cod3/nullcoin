    ...
    platformStyle(_platformStyle)
{
    ...
    // normal nullcoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying nullcoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &NullcoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
