    ...
    mapper(nullptr)
{
    ...
    ui->nullcoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->nullcoinAtStartup);
    ...
    ui->nullcoinAtStartup->setToolTip(ui->nullcoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->nullcoinAtStartup->setText(ui->nullcoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openNullcoinConfButton->setToolTip(ui->openNullcoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new NullcoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->nullcoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openNullcoinConfButton_clicked()
{
