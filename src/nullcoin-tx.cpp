...
static void SetupNullcoinTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " nullcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  nullcoin-tx [options] <hex-tx> [commands]  Update hex-encoded nullcoin transaction\n" +
            "or:     nullcoin-tx [options] -create [commands]   Create hex-encoded nullcoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded nullcoin transaction
