...
/* A AEAD class for ChaCha20-Poly1305@nullcoin.
 *
 ...
 *
 * The chacha20-poly1305@nullcoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@nullcoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@nullcoin are relatively fast in
