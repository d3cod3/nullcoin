...
{
    const char* pszTimestamp = "The Guardian 15/May/2020 Dutch official advice: find a sex buddy for lockdown";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1589648153, 2469796704, 0x1d00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000000101ea067a65c8b6c50768f7d0fbc6e8a679dba4de9a1ead9473b3141"));
        assert(genesis.hashMerkleRoot == uint256S("0x6edce19d7352bbdca4e58b54fc7a6b88f92f9f75ebb22b739866074a419c430f"));
...
public:
    CTestNetParams() {
        ...
        //vSeeds.emplace_back("testnet-seed.nullcoin.jonasschnelli.ch");
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x15a7e2976018c71fd94a7552cb22705db648a3d15b02f6a842abfd6b10f6953c"));
        assert(genesis.hashMerkleRoot == uint256S("0x6edce19d7352bbdca4e58b54fc7a6b88f92f9f75ebb22b739866074a419c430f"));
